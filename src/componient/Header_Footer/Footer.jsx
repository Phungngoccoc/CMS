            ...
            <div className="container">
                <div className="row up ps-3 ps-sm-0">
                    ...
                    <div className="col-12 col-sm-6 col-lg-3 ">
                        ...
                        <p>
                            <a>{languageApp === "vi" ? "Câu chuyện thành công" : "Customer Stories"}</a><br />
                            <a>{languageApp === "vi" ? "Ngành/Lĩnh vực" : "Case Studies"}</a><br />
                    ...
                    <div className="col-12 col-sm-6 col-lg-3 ">
                        ...
                        <p>
                            <a>Blog</a><br />
                            <a>{languageApp === "vi" ? "Sách điện tử và sách trắng" : "Ebooks & Whitepapers"}</a><br />
                ...
                <div className="down d-lg-flex justify-content-between align-items-center">
                    <div className="social-network d-flex justify-content-center align-items-center">
                        <div className="d-flex justify-content-between align-items-center mb-4">
                            <div className="item"><i className="fa fa-facebook"></i></div>
                            <div className="item mx-5"><i className="fa fa-twitter"></i></div>
                            <div className="item"><i className="fa fa-linkedin"></i></div>
                        </div>
                    </div>
